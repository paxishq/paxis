      ...
      <div className="w-full max-w-[320px] space-y-8">
        <div className="flex flex-col items-center gap-3">
          ...
          <div className="text-center">
            ...
            <p className="text-[13px] text-zinc-500 mt-1">EU compliance OS for your supply chain</p>
          </div>
        </div>
        <div className="rounded-lg border border-white/[0.07] bg-white/[0.025] p-5 space-y-4">
          ...
          <form onSubmit={signInEmail} className="space-y-2">
            <input
              ...
              required
              className="w-full h-9 rounded-md border border-white/[0.1] bg-white/[0.04] px-3 text-[13px] text-zinc-200 placeholder:text-zinc-600 focus:outline-none focus:border-blue-500/50"
            />
            <input
              type="password"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full h-9 rounded-md bg-blue-600 hover:bg-blue-500 text-[13px] font-medium text-white transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
